  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path='/' element={<> <Carousel data={slides} /> <MainSection/> <Homeproducts cart={cart} setCart={setCart} favourites={favourites} setFavourites={setFavourites} /> <Testimonials/> <Footer/> </>} />
