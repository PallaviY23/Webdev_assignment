    ...
    <>
                ...
                <div className="row p-4 g-0">
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      ...
                      <p className="text-center my-1.5 text-slate-500">
                        {product.description}
                      </p>
                      <div className="ml-32 mt-2 flex gap-8">
                      <Link to={'/Register'}
                        className="text-white w-99   bg-orange-700 hover:bg-slate-500 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-8 py-2.5 lg:py-2.5 mr-2 focus:outline-none"
                      >
                        Buy Now
                      </Link>
...

      {
          cart.length !=0 && (
            ...
            <button className="text-white w-99   bg-orange-700  focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-8 py-2.5 lg:py-2.5 mr-2 focus:outline-none" onClick={()=>setCart("") }>
              Clear Cart
            </button>
          </div>
          )
